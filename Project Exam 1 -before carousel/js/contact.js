...
function buttonDisabledCheck() {
    if (checklength(fullName, 5) && validateEmail(email.value) && checklength(subject, 15) && checklength(message, 25)) {
...
subject.addEventListener("keyup", buttonDisabledCheck);
message.addEventListener("keyup", buttonDisabledCheck);
